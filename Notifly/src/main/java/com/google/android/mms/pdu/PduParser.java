...
public class PduParser {
    ...
    public PduHeaders parseHeaders(byte[] array) {
        ByteArrayInputStream bais = new ByteArrayInputStream(array);
        return parseHeaders(bais);
    }
            ...
            if (header > TEXT_MAX) {
                ...
                switch (header) {
                    ...
                    case PduPart.P_CONTENT_DISPOSITION:
                         ...
                         * field correctly
                         */
                        boolean contentDisposition = Resources.getSystem().getBoolean(Resources.getSystem().getIdentifier("config_mms_content_disposition_support","bool", "android"));
